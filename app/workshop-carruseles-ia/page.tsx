...
export const metadata = {
  ...
  description: 'Regístrate gratis al workshop práctico para crear carruseles con inteligencia artificial.',
};
  ...
  return (
    <main className="workshop-page">
      <header className="workshop-header">
        ...
        <span className="workshop-status"><i /> Registro gratuito abierto</span>
      </header>
      ...
      <section className="workshop-layout">
        ...
        <div className="workshop-form-card" id="registro">
          <span className="workshop-step">01 / REGISTRO GRATUITO</span>
          <h2>Reserva tu lugar gratis</h2>
          <p>Déjame tu nombre y correo para enviarte la fecha y los detalles de acceso cuando estén confirmados.</p>
          ...
          <form name="interes-workshop-carruseles-ia" method="POST" action="/workshop-carruseles-ia/gracias" data-netlify="true">
            ...
            <input type="hidden" name="origen" value="workshop-carruseles-ia" />
            ...
            <button type="submit">Inscribirme gratis <ArrowRight size={17} /></button>
