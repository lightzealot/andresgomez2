...
export const resources = [
  ...
  { slug: 'mejores-resultados-ia', type: 'Plantilla', category: 'Prompts', title: 'Plantilla para pedirle mejores resultados a cualquier IA', description: 'Explica tu situación, define el objetivo y pide el formato que necesitas.', image: 'mejores-resultados-ia', download: '3.txt' },
